    ...
    <Box className="!flex !h-screen !w-full !relative">
      ...
      <Box className="!relative !w-full">
        ...
        <Box className="!grid !absolute !bottom-[100px] !left-[100px] !z-10 xl:!gap-5 !gap-3 ">
          <Typography
            variant="h1"
            className=" !text-[--white] !font-bold xl:!text-[40px] !text-[28px]"
          >
            Numquam architecto iure
          </Typography>
          <Typography
            variant="caption"
            className="xl:!text-2xl !text-base !max-w-[490px] xl:!pr-0 !pr-10 !text-[--white] Inter400 xl:!leading-7 !leading-5"
          >
